...
import core.common.LogCreate.LogLevel;
...
public class FileOperation {
	 ...
	 * {@link core.common.FileOperation#writeCsvFile csvファイルを書き込むメソッド詳細}
	 * </p><p>
	 * [DAT]<br>
	 * 2次元か３次元配列をinputDataに設定することでファイルに記述する。<br>
	 * {@link core.common.FileOperation#writeDatFile datファイルを書き込むメソッド詳細}
	 * </p><p>
	 * [TXT]<br>
	 * inputDataの内容をそのままtxtファイルに記述する。<br>
	 * {@link core.common.FileOperation#writeTxtFile txtファイルを書き込むメソッド詳細}
	 * </p>
